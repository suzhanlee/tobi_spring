...
import static com.tobi_spring.chapter5.transactionv2.UserService.MIN_LOGCOUNT_FOR_SILVER;
import static com.tobi_spring.chapter5.transactionv2.UserService.MIN_RECOMMEND_FOR_GOLD;
...
class UserServiceTest {
    ...
    void upgradeAllOrNothing() {
        UserServiceTest.TestUserService testUserService = new UserServiceTest.TestUserService(users.get(3).getId());
